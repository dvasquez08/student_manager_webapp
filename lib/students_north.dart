...
class studentsNorth extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (isLoading == true) {
      viewModelProvider.studentStream();
      isLoading = false;
    }
          ...
          children: [
            Row(
              children: [
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 15.0),
                        NavButton(
                            "Terwilliger Students", studentsTerwilliger()),
                        SizedBox(height: 15.0),
                ...
                // Beginning of main section that shows the lists
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextBlack("North Students", 40.0),
                      SizedBox(height: 20.0),
                      TextBlack("Attended", 25.0),

                      // Beginning of attendance list section
                ...
                // End of main section with lists
              ],
            ),
